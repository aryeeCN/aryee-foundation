...
/**
 * Aryee Messaging Kafka Blocking 模式示例应用启动类
 *
 * <p>依赖说明：
 * <ul>
...
public class MessagingKafkaExamplesApplication {

    public static void main(String[] args) {
        SpringApplication.run(MessagingKafkaExamplesApplication.class, args);
    }
}
